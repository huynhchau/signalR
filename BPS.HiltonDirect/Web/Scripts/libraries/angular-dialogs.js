...
.factory('$dialogs', [
    ...
    */
            error: function (msg) {
                return $modal.open({
                    templateUrl: '/Style Library/NGO.Online/Scripts/Application/Libraries/error.html',
                    controller: 'errorDialogCtrl',
                    resolve: {
                        msg: function () {
    ...
    */
            wait: function (msg, progress) {
                return $modal.open({
                    templateUrl: '/Style Library/NGO.Online/Scripts/Application/Libraries/wait.html',
                    controller: 'waitDialogCtrl',
                    resolve: {
                        msg: function () {
                            return angular.copy(msg);
    ...
    */
            notify: function (header, msg) {
                return $modal.open({
                    templateUrl: '/Style Library/NGO.Online/Scripts/Application/Libraries/notify.html',
                    controller: 'notifyDialogCtrl',
                    resolve: {
                        header: function () {
    ...
    */
            confirm: function (header, msg) {
                return $modal.open({
                    templateUrl: '/Style Library/NGO.Online/Scripts/Application/Libraries/confirm.html',
                    controller: 'confirmDialogCtrl',
                    resolve: {
                        header: function () {
                            return angular.copy(header);
...
"$templateCache",
    function (o) {
        //o.put("/Application/View/Controllers/dialogs/error.html",
        ...
        //o.put("/Application/View/Controllers/dialogs/wait.html",
        ...
        //o.put("/Application/View/Controllers/dialogs/notify.html",
        ...
        //o.put("/Application/View/Controllers/dialogs/confirm.html",
